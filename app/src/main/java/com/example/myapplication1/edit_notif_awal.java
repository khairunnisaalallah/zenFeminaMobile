...
public class edit_notif_awal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, urlreminder, null,new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                        ...
                        pengingat = userData.getString("reminderDays");
                    ...
                    e.printStackTrace();
                    Toast.makeText(edit_notif_awal.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(edit_notif_awal.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });

        // Menambahkan permintaan estimasi ke dalam antrian
        RequestQueue estimationQueue = Volley.newRequestQueue(edit_notif_awal.this);
        ...
        btnSimpan = findViewById(R.id.simpanawal);
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if (status.equals("1")) {
                                        ...
                                        Intent intent = new Intent(edit_notif_awal.this, notifActivity.class);
                    ...
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(edit_notif_awal.this, "Terjadi kesalahan, coba lagi nanti", Toast.LENGTH_SHORT).show();
        ...
        btnJam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog = new TimePickerDialog(edit_notif_awal.this, R.style.CustomTimePickerDialogStyle, new TimePickerDialog.OnTimeSetListener() {
                    @Override
